...
function LoginPage() {
  ...
  const handleSignIn = async () => {
    setLoading(true); // indicates the process starts
    try {
      await googleSignIn();
      setLoading(false); // indicates the process ends
  ...
  useEffect(() => {
    if (user && !loading) { // if user is logged in and loading is false redirect to dashboard
      ...
      <div className="p-4 max-w-md mx-auto bg-gray-100 rounded-lg shadow-md">
        ...
        {loading ? (
          ...
          <div>
            ...
            // Add form for email and password login here
            <form>
              <div className="mb-4">
